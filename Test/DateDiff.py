...
if __name__ == '__main__':
    ...
    # path = r'C:\Users\UC227911\Desktop\Mine\O2O\O2OTrainModelPy\Resource\features\online\trainMerFeature'
    # result = None
    # sum = 0
    # for i in range(15):
    #     if i < 10:
    ...
    #
    # result.to_csv(
    #     r'C:\Users\UC227911\Desktop\Mine\O2O\O2OTrainModelPy\Resource\features\online\trainMerFeature\merchant_feature.csv',
    #     index=False)
